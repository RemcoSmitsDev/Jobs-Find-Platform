...
<div class="px-6 space-y-4 container mx-auto max-w-screen-lg flex flex-wrap-reverse justify-center">
    <div class="lg:mt-0 mt-12 lg:w-1/4 w-full lg:block flex">
        <div class="hidden lg:block mb-4 h-12 w-12 lg:h-24 lg:w-24 rounded-full overflow-hidden shadow flex-shrink-0">
        ...
        <div class="w-full space-y-2 flex-shrink-0">
            <p class="lg:mb-0 mb-8 pb-2 font-bold text-lg md:border-0 border-b lg:text-left text-center">Extra
                information</p>
    ...
    <div class="lg:mr-10 max-w-2xl">
        <p class="pb-2 mb-8 font-semibold text-xl text-center border-b">{{ $job->title }} by
            {{ $job->company_name }}
        </p>
